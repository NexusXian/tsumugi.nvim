local colorscheme_name = "tsumugi"

vim.api.nvim_set_var("colors_name", colorscheme_name)

-- my color
local Nexusdark = { "#5f575c", 243, "black" }
local Nexusmagenta = { "#d5508f", 126, "magenta" }
local Nexuspurple = { "#af87d7", 77, "magenta" }
local Nexusice = { "#75b8c7", 88, "blue" }
local Nexusblue = { "#61bff3", 137, "blue" }
local Nexusgray = { "#3e3c3d", 189, "gray" }
local Nexusgreen = { "#5cca95", 181, "green" }
...
colorscheme.highlight_all({
  ...
  tsumugiBg4 = { fg = bg4 },
  tsumugiRed = { fg = red },
  tsumugiRedBold = { fg = red, bold = true },
  tsumugiGreen = { fg = green },
  tsumugiGreenBold = { fg = green, bold = true },
  tsumugiYellow = { fg = yellow },
  tsumugiYellowBold = { fg = yellow, bold = true },
  tsumugiBlue = { fg = blue },
  tsumugiBlueBold = { fg = blue, bold = true },
  tsumugiPurple = { fg = purple },
  tsumugiPurpleBold = { fg = purple, bold = true },
  tsumugiAqua = { fg = aqua },
  tsumugiAquaBold = { fg = aqua, bold = true },
  tsumugiOrange = { fg = orange },
  ...
  Conceal = { fg = blue },
  EndOfBuffer = "NonText",
  Ignore = "tsumugiPurple",
  NonText = { fg = Nexusdark },
  ...
  Tag = "Underlined",
  Type = "tsumugiYellow",
  Typedef = "tsumugiYellow",

  -- Pre-processor
  Define = "tsumugiAqua",
  Include = "tsumugiAqua",
  Macro = "tsumugiAqua",
  PreCondit = "tsumugiAqua",
  PreProc = "tsumugiAqua",

  -- Special
  Special = { fg = orange, bold = false },
  SpecialChar = "tsumugiOrange",
  SpecialComment = { fg = gray, bold = true, nocombine = true },
  SpecialKey = "tsumugiOrange",
  ...
  CursorLineNr = function(self)
    return { fg = fg1, bg = self.LineNr.bg }
  end,
  LineNr = { fg = bg4 },
  ...
  FloatBorder = { fg = gray },
  Pmenu = function(self)
    return { fg = self.Normal.fg, bg = bg2 }
  end,
  PmenuSbar = { bg = bg2 },
  PmenuSel = { fg = bg2, bg = blue, bold = true },
  PmenuThumb = { bg = bg4 },
  WildMenu = { fg = Nexuspurple, bg = bg2, bold = true, reverse = true },
  ...
  Hint = { fg = Nexusmagenta, bg = bg2, bold = true },
  ...
  HintMsg = { fg = Nexusmagenta, bold = true },
  ErrorMsg = { fg = red, bold = true },
  InfoMsg = { fg = aqua, bold = true },
  ModeMsg = "tsumugiYellowBold",
  ...
  DiagnosticUnderlineHint = { sp = Nexusmagenta, undercurl = true },

  DiagnosticInfo = "Info",
  DiagnosticFloatingInfo = "InfoMsg",
  DiagnosticSignInfo = "DiagnosticFloatingInfo",
  DiagnosticUnderlineInfo = { sp = Nexuspurple, undercurl = true },
  ...
  DiagnosticUnnecessary = function(self)
    return { sp = self.Ignore.fg, underdotted = true }
  end,
  ...
  ["@lsp.typemod.variable.definition.lua"] = { fg = yellow, bold = true },
  ...
  CmpItemAbbrMatchFuzzy = function(self)
    return { fg = self.Normal.fg, nocombine = true, bold = true }
  end,
  ...
  CmpItemKindField = "tsumugiYellow",
  CmpItemKindFile = "Directory",
  CmpItemKindFolder = "CmpItemKindFile",
  CmpItemKindFunction = "tsumugiAquaBold",
  CmpItemKindInterface = { fg = aqua },
  ...
  TodoFgFIX = function(self)
    return { fg = self.DiagnosticFloatingError.fg }
  end,
  TodoFgHACK = { fg = yellow },
  TodoFgNOTE = function(self)
    return { fg = self.DiagnosticFloatingInfo.fg }
  end,
  TodoFgPERF = function(self)
    return { fg = self.DiagnosticFloatingHint.fg }
  end,
  TodoFgTODO = { fg = bright_purple },
  TodoFgWARN = function(self)
    return { fg = self.DiagnosticFloatingWarn.fg }
  end,

  TodoBgFIX = function(self)
    return { fg = black, bg = self.TodoFgFIX.fg, bold = true, italic = true, nocombine = true }
  end,
  TodoBgHACK = function(self)
    return { fg = black, bg = self.TodoFgHACK.fg, bold = true, italic = true, nocombine = true }
  end,
  TodoBgNOTE = function(self)
    return { fg = black, bg = self.TodoFgNOTE.fg, bold = true, italic = true, nocombine = true }
  end,
  TodoBgPERF = function(self)
    return { fg = black, bg = self.TodoFgPERF.fg, bold = true, italic = true, nocombine = true }
  end,
  TodoBgTODO = function(self)
    return { fg = black, bg = self.TodoFgTODO.fg, bold = true, italic = true, nocombine = true }
  end,
  TodoBgWARN = function(self)
    return { fg = black, bg = self.TodoFgWARN.fg, bold = true, italic = true, nocombine = true }
  end,
  ...
  -- my statusline
  StatusLineNormal = { fg = dsdark0, bg = Nexuspurple, bold = true },
  ...
  StatusLineTerminal = { fg = dsdark0, bg = Nexusice, bold = true },
  StatusLineBranch = { fg = Nexusgreen, bg = Nexusblack, bold = true },
  StatusLineHunkAdd = { fg = green, bg = Nexusblack, bold = true },
  StatusLineHunkChange = { fg = orange, bg = Nexusblack, bold = true },
  StatusLineHunkRemove = { fg = terminal_color_1, bg = Nexusblack, bold = true },
  StatusLineFormat = { fg = blue, bg = dsdark2 },
  StatusLineCocStatus = { fg = Nexusmagenta, bg = dsdark2 },
  StatusLineFileSize = { fg = Nexusice, bg = Nexusgray },
  StatusLineFileModified = { fg = purple, bg = dsdark2 },
  StatusLineFileName = { fg = Nexusice, bg = dsdark2 },
  StatusLineInformation = { fg = dslight2, bg = dsdark2, bold = true },
  StatusLineHint = { fg = Nexusmagenta, bg = dsdark2, bold = true },
  ...
  -- nvim-dap
  DapBreakpoint = { fg = Nexusmagenta },
  DapLogPoint = { fg = Nexusblue },
  DapStopped = "tsumugiGreen",

  -- flash.nvim
  FlashMatch = { fg = dsdark0, bg = Nexuspurple },
  FlashCurrent = { fg = dsdark0, bg = orange },
  FlashLabel = { fg = dsdark0, bg = Nexusmagenta },
